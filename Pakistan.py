...
br.addheaders = [('Mozilla/5.0 (Linux; Android 11; Mi A3 Build/RKQ1.200903.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/323.0.0.46.119;]')]
def exit():
	print "[!] Exit"
	os.sys.exit()
